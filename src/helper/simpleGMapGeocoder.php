...
function getGeoCoords($address)
{
    ...
    $geoCodeURL = "https://maps.google.com/maps/api/geocode/json?address=".urlencode($address)."&key=".SiteConfig::current_site_config()->MapsAPIKey;
...
function reverseGeoCode($lat,$lng)
{
    ...
    // call geoencoding api with param json for output
    $geoCodeURL = "https://maps.google.com/maps/api/geocode/json?address=$lat,$lng&sensor=false"."&key=".SiteConfig::current_site_config()->MapsAPIKey;
